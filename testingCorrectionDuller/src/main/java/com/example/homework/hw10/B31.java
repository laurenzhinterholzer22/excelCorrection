package com.example.homework.hw10;
...
public class B31 {
    public static void main(String[] args) {
        ...
        String abgabe_directory = "ExcelFiles/Abgabe/Beispiel31_Abgabe.xlsx";
        String loesung_directory = "ExcelFiles/Loesungen/Beispiel31_Loesung.xlsx";
